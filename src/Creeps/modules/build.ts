...
const build = (creep: Creep): string | void=> {
  ...
  if (flagMemory.commonMemory.constructionSites.length === 0 && !creepMemory.targetId) {
  ...
  if (creepMemory.targetId === undefined) {
    ...
    switch (result) {
      ...
      case ERR_INVALID_TARGET:
        ...
        if (flagMemory.commonMemory.constructionSites.indexOf(creep.memory.targetId) === 0) {
