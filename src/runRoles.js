...
const pioneer = (creep, roleName) => {
  ...
  case 'full':
    ...
    if (creep.room.energyAvailable !== creep.room.energyCapacityAvailable || (flagMemory.commonMemory.capacity > 10000 && flagMemory.commonMemory.capacity / 10 > flagMemory.commonMemory.usable)) {
