...
class Traveler {
  ...
  static patchMemory(cleanup = false) {
    ...
    let count = 0;
    const hostileRooms = Memory.empire.hostileRooms;
    for (const roomName in hostileRooms) {
      if (Object.prototype.hasOwnProperty.call(hostileRooms, roomName)) {
