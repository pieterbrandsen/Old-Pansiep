module.exports = {
    run: function (creep) {
      ...
      creepMemory.reactions = REACTIONS;

      // if (creepMemory.reactions.length > 0) {
      //   for (int i = 0; i< creepMemory.reactions.length;i++) {
      //     for (int i2 = 0; i2< creepMemory.reactions[i].length;i2++) {
      //       if (creepMemory.reactions[i][i2] == flag.reactionsNeeded[0]) {
      //         let array = creepMemory.reactions[i],creepMemory.reactions[i][i2],flag.reactionsNeeded[0]]
      //       }
      //   }
      // }

      //console.log(creepMemory.reactions[0][0])
