...
module.exports.loop = function() {
    profiler.wrap(function () {
        if (Game.cpu.bucket > 1000) {
            ...
            let terminalSend = 25000;
            if (terminalTMa !== undefined && (terminalTMi < 25000 && terminalTMa > 20000)) {
...
*/
            ...
            _.forEach(Object.keys(Game.rooms), function (roomName) {
                ...
                if (controller && controller.my) {
                    ...
                    if (Game.time % 2500 == 0) {
                        Memory.rooms[roomName + '.construction'] = room.find(FIND_CONSTRUCTION_SITES);
                    }
                    if (Game.time % 50 == 0) {
            ...
            if (Game.time % 10 == 0) {
                _.forEach(Object.keys(Game.rooms), function (roomName) {
                    ...
                    if (controller && controller.my) {
                        ...
                        let construction = Memory.rooms[roomName + '.construction'];
                        ...
                        let transfererSpawn = room.terminal.pos.findClosestByRange(room.spawns, {
                            filter: (structure) => {
                        ...
                        if (controller.level >= 1 && controller.level <= 2 && extension >= 0) {
                            ...
                            else if (needsCreeps("repairerSo1", roomName, 1) && sources[1] !== undefined) {
                                spawn[0].spawnCreep(
                                    [MOVE,
                                    WORK, WORK,
                                    CARRY],
                            ...
                            else if (needsCreeps("repairer1", roomName, 1)) {
                                spawn[0].spawnCreep(
                                    repairerCo,
                                'Repairer' + Game.time,
                                {
                            ...
                            Game.spawns[transfererSpawn].spawnCreep(
                                    transfererLiTe,
                                'Transferer' + Game.time,
                                {
                                    memory: {
                        ...
                        if (roomName == "E43N1") {
                            let target = "E44N1"
                            let builderLD = [MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,
                            ...
                            if (needsCreeps("reserver1", roomName, 1)) {
                                spawn[0].spawnCreep(
                                    reserver,
                                'Reserver' + Game.time,
                                {
                            ...
                            else if (needsCreeps("transfererLD1", roomName, 3)) {
                                spawn[0].spawnCreep(
                                    transfererLD,
                                'Transferer' + Game.time,
                                {
                            ...
                            else if (needsCreeps("harvesterLD1", roomName, 1)) {
                                spawn[0].spawnCreep(
                                    harvesterLD,
                                'Harvester' + Game.time,
                                {
                            ...
                            else if (needsCreeps("harvesterLD2", roomName, 1)) {
                                spawn[0].spawnCreep(
                                    harvesterLD,
                                'Harvester' + Game.time,
                                {
