...
module.exports.loop = function() {
    profiler.wrap(function() {
        ...
        const linkTo41 = Game.getObjectById("5d59ae9e3b552d638902b9f8");
        const linkFrom42 = Game.getObjectById("5d59ae9e3b552d638902b9f8");
        const linkTo42 = Game.getObjectById("5d4f03abe360cc20d4c03077");
        linkFrom41.transferEnergy(linkTo41);
        linkFrom42.transferEnergy(linkTo42);
        ...
        const terminal4 = Game.getObjectById("5d5a4170cb3b537470abb0df");

        let terminalTMi = Math.min(terminalt1, terminalt2, terminalt3, terminalt4);
        let terminalTMa = Math.max(terminalt1, terminalt2, terminalt3, terminalt4);
        ...
        if (terminalTMa !== undefined && (terminalTMi * 2 < terminalTMa)) {
            ...
            if (terminalSend !== undefined && terminalt4 === terminalTMa) {
                if (terminalt1 === terminalTMi) {
                    if (terminalTMa - terminalSend > terminalTMi) {
        ...
        let terminalTotal = (terminalt1 + terminalt2 + terminalt3 + terminalt4);
        ...
        terminalHYDROXIDE = Game.rooms[room].terminal.store[RESOURCE_HYDROXIDE];

        terminalZYNTHIUM_KEANITE = Game.rooms[room].terminal.store[RESOURCE_ZYNTHIUM_KEANITE];

        terminalUTRIUM_LEMERGITE = Game.rooms[room].terminal.store[RESOURCE_UTRIUM_LEMERGITE];

        terminalGHODIUM = Game.rooms[room].terminal.store[RESOURCE_GHODIUM];

        //TIER 1 COMPOUNDS

        terminalUTRIUM_HYDRIDE = Game.rooms[room].terminal.store[RESOURCE_UTRIUM_HYDRIDE];


        terminalUTRIUM_OXIDE = Game.rooms[room].terminal.store[RESOURCE_UTRIUM_OXIDE];


        terminalKEANIUM_HYDRIDE = Game.rooms[room].terminal.store[RESOURCE_KEANIUM_HYDRIDE];


        terminalKEANIUM_OXIDE = Game.rooms[room].terminal.store[RESOURCE_KEANIUM_OXIDE];


        terminalLEMERGIUM_HYDRIDE = Game.rooms[room].terminal.store[RESOURCE_LEMERGIUM_HYDRIDE];


        terminalLEMERGIUM_OXIDE = Game.rooms[room].terminal.store[RESOURCE_LEMERGIUM_OXIDE];


        terminalZYNTHIUM_HYDRIDE = Game.rooms[room].terminal.store[RESOURCE_ZYNTHIUM_HYDRIDE];


        terminalZYNTHIUM_OXIDE = Game.rooms[room].terminal.store[RESOURCE_ZYNTHIUM_OXIDE];


        terminalGHODIUM_HYDRIDE = Game.rooms[room].terminal.store[RESOURCE_GHODIUM_HYDRIDE];


        terminalGHODIUM_OXIDE = Game.rooms[room].terminal.store[RESOURCE_GHODIUM_OXIDE];
        ...
        /*if (terminalKEANIUM < 5000 || terminalKEANIUM === undefined) {
            terminal1.send(RESOURCE_KEANIUM, 1000, room')
        }*/
        ...
        else if (needsCreeps("harvesterLi1", spawn, 2) && needsCreeps("SharvesterLi1", spawn, 1) && harvester === ERR_NOT_ENOUGH_ENERGY) {
            Game.spawns[spawn].spawnCreep(
                [MOVE,
                    WORK,WORK,
                    CARRY],
        ...
        else if (needsCreeps("transfererLi", spawn, 1) && needsCreeps("StransfererLi", spawn, 1) && transferer === ERR_NOT_ENOUGH_ENERGY) {
            Game.spawns[spawn].spawnCreep(
                [MOVE, MOVE, MOVE,
                    CARRY, CARRY, CARRY],
                'StarterTransferer' + Game.time,
        ...
        else if (needsCreeps("harvesterLi1", spawn, 2)) {
            Game.spawns[spawn].spawnCreep(
                [MOVE,
                    WORK,WORK,WORK,
                    CARRY,],
