module.exports = {
    run: function(creep) {
        ...
        if (creep.memory.working === true) {
            ...
            let target2 = creep.pos.findClosestByRange(creep.room.containers, {
                filter: (structure) => {
                    return (structure.pos.inRangeTo(creep.room.controller, 5));
                }
            });
            // if (_.size(creep.memory.container2) == 0 && creep.room.controller.level <= 5) {
            ...
            else if(target2 !== null && creep.room.controller.level <= 5) {
