module.exports = {
    run: function (creep) {
        let labs = creep.pos.findClosestByRange(creep.room.labs, {
            filter: (structure) => {
                return (structure.id);
            }
        });
        ...
        let lab1MineralAmount = lab1.store[lab1.mineralType];
        let lab2MineralAmount = lab2.store[lab2.mineralType];
        let lab3MineralAmount = lab3.store[lab3.mineralType];
        let lab4MineralAmount = lab4.store[lab4.mineralType];
        let lab5MineralAmount = lab1.store[lab5.mineralType];
        let lab6MineralAmount = lab6.store[lab6.mineralType];
        let lab7MineralAmount = lab7.store[lab7.mineralType];
        let lab8MineralAmount = lab8.store[lab8.mineralType];
        let lab9MineralAmount = lab9.store[lab9.mineralType];
        let lab10MineralAmount = lab10.store[lab10.mineralType];
