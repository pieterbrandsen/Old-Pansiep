    ...
    profiler.wrap(function () {
        if (Game.cpu.bucket > 1000) {
            ...
            for (let name in Game.creeps) {
                ...
                if (creep.memory.role === 'longDistanceBuilderTe1') {
                ...
                if (creep.memory.role === 'transfererSt') {
                    roleTransfererStorage.run(creep);
                }
            ...
            } else if (needsCreeps("transfererTe", home, 1) && needsCreeps("StransfererTe", home, 3) && transferer === ERR_NOT_ENOUGH_ENERGY) {
                Game.spawns[spawn].spawnCreep(
                    [MOVE, MOVE, MOVE,
                        CARRY, CARRY, CARRY],
                    'StarterTransferer' + Game.time,
            ...
            } else if (needsCreeps("transfererLi", home, 0) && needsCreeps("StransfererLi", home, 3) && transferer === ERR_NOT_ENOUGH_ENERGY) {
                Game.spawns[spawn].spawnCreep(
                    [MOVE, MOVE, MOVE,
                        CARRY, CARRY, CARRY],
                    'StarterTransferer' + Game.time,
            ...
            } else if (needsCreeps("builderTe", home, 1)) {
                Game.spawns[spawn2].spawnCreep(
                    [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE,MOVE,MOVE,
                        WORK, WORK, WORK,WORK, WORK, WORK,WORK, WORK, WORK,WORK,
                        CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY],
            ...
            } else if (needsCreeps("longDistanceBuilderTe1", home, 0)) {
                Game.spawns[spawn].spawnCreep(
                    [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE,
                        WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK,
                        CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY],
            ...
            } else if (needsCreeps("transfererTe", home, 1) && needsCreeps("StransfererTe", home, 2) && transferer === ERR_NOT_ENOUGH_ENERGY) {
                Game.spawns[spawn].spawnCreep(
                    [MOVE, MOVE, MOVE,
                        CARRY, CARRY, CARRY],
                    'StarterTransferer' + Game.time,
            ...
            } else if (needsCreeps("builderTe", home, 2)) {
                Game.spawns[spawn].spawnCreep(
                    [MOVE, MOVE, MOVE, MOVE, MOVE,
                        WORK, WORK, WORK, WORK, WORK,
                        CARRY, CARRY, CARRY, CARRY, CARRY],
            ...
            } else if (needsCreeps("transfererLi", home, 1) && needsCreeps("StransfererLi", home, 3) && transferer === ERR_NOT_ENOUGH_ENERGY) {
                Game.spawns[spawn].spawnCreep(
                    [MOVE, MOVE, MOVE,
                        CARRY, CARRY, CARRY],
                    'StarterTransferer' + Game.time,
