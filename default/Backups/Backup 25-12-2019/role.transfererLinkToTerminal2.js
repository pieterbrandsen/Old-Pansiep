module.exports = {
    ...
    run: function(creep) {
        ...
        function needsResource(resource, amount) {
            ...
            return numberOfResourceTerminal < amount && numberOFResourceStorage > amount || numberOfResourceTerminal > amount && numberOFResourceStorage < amount
        }
            /*if (numberOFResourceStorage === undefined && numberOfResourceTerminal !== undefined) {
                let numberOFResourceStorage = 0
                if (numberOfResourceTerminal < amount && numberOFResourceStorage > amount) {return true}
                else if (numberOfResourceTerminal > amount && numberOFResourceStorage < amount) {return true}
                else {return false}
            }
            else if (numberOfResourceTerminal === undefined && numberOFResourceStorage !== undefined) {
                let numberOfResourceTerminal = 0
                if (numberOfResourceTerminal < amount && numberOFResourceStorage > amount) {return true}
                else if (numberOfResourceTerminal > amount && numberOFResourceStorage < amount) {return true}
                else {return false}
            }
        ...
        if (creep.room.terminal.store[RESOURCE_ENERGY] > 49990) {
        ...
        let flag;
        let x;
        if (Game.flags["RESOURCE_HYDROGEN"] !== undefined && Game.flags["RESOURCE_HYDROGEN"].room === creep.room || needsResource(RESOURCE_HYDROGEN, 4999)) {
        ...
        else if (Game.flags["RESOURCE_OXYGEN"] !== undefined && Game.flags["RESOURCE_OXYGEN"].room === creep.room || needsResource(RESOURCE_OXYGEN, 4999)) {
        ...
        else if (Game.flags["RESOURCE_UTRIUM"] !== undefined && Game.flags["RESOURCE_UTRIUM"].room === creep.room || needsResource(RESOURCE_UTRIUM, 4999)) {
        ...
        else if (Game.flags["RESOURCE_KEANIUM"] !== undefined && Game.flags["RESOURCE_KEANIUM"].room === creep.room || needsResource(RESOURCE_KEANIUM, 4999)) {
        ...
        else if (Game.flags["RESOURCE_LEMERGIUM"] !== undefined && Game.flags["RESOURCE_LEMERGIUM"].room === creep.room || needsResource(RESOURCE_LEMERGIUM, 4999)) {
        ...
        else if (Game.flags["RESOURCE_ZYNTHIUM"] !== undefined && Game.flags["RESOURCE_ZYNTHIUM"].room === creep.room || needsResource(RESOURCE_ZYNTHIUM, 4999)) {
        ...
        else if (Game.flags["RESOURCE_CATALYST"] !== undefined && Game.flags["RESOURCE_CATALYST"].room === creep.room || needsResource(RESOURCE_CATALYST, 4999)) {
        ...
        else if (creep.room.terminal.store[RESOURCE_ENERGY] < 49990 && creep.room.storage.store[RESOURCE_ENERGY] > 1000) {
            if (creep.withdraw(creep.room.storage, RESOURCE_ENERGY) === ERR_NOT_IN_RANGE) {
                creep.travelTo(creep.room.storage)
            }
        }

        else if (creep.room.terminal.store[RESOURCE_ENERGY] < 49990 && creep.room.storage.store[RESOURCE_ENERGY] < 499900) {
            if (creep.withdraw(target, RESOURCE_ENERGY) === ERR_NOT_IN_RANGE) {
                creep.travelTo(target)
            }
        }
        else if (creep.room.terminal.store[RESOURCE_ENERGY] > 49990) {
            if (creep.transfer(creep.room.storage, RESOURCE_ENERGY) === ERR_NOT_IN_RANGE) {
                creep.travelTo(creep.room.storage)
            }
        }
