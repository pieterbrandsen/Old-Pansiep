            ...
            _.forEach(Object.keys(Game.rooms), function (roomName) {
              ...
              if (Game.flags[roomName] !== undefined) {
                ...
                if (controller && controller.my) {
                  ...
                  // SPAWN CHECKS //
                  if (Game.time % 10 == 0 || flag.totalEnergyAvailable == undefined || flag.totalEnergyCapacity == undefined) {
                    flag.totalEnergyAvailable = room.energyAvailable;
                    flag.totalEnergyCapacity = room.energyCapacityAvailable;
                  }
                  if (Game.time % 10000 == 0 || flag.transfererSpawn == undefined) {
                  ...
                  // FIX DIT, MOET NIET ELKE KEER GECALLED WORDEN
